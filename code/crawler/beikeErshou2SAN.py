...
def get_home_detail_infos(detail_url, page, idx):
    ...
    # 小区建造时间
    xiaoqu_built_time_divs = html.xpath('//div[@class="xiaoquCard"]//div[@class="xiaoqu_main fl"]//span[@class="xiaoqu_main_info"]/text()')
    xiaoqu_built_time = ''
    if xiaoqu_built_time_divs is None or len(xiaoqu_built_time_divs) == 0:
        xiaoqu_built_time = '暂无数据'
    else:
        xiaoqu_built_time = \
