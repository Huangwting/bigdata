...
page_start = 1
page_size = 100
file_name = 'data/ajk_tianjin_ershoufang_di' + str(page_start) + '.csv'
...
def craw_anjuke(craw_url, proxy):
    ...
    headers = {
        ...
        'cookie': 'aQQ_ajkguid=B92A5535-A853-AE39-3FE0-CC7FF20AFF15; ajk-appVersion=; seo_source_type=0; fzq_h=50a0151b8d140cb10989afc75518cd36_1706423722253_e9dcb3ef62b14a21841e27de05e4a05a_1911188441; id58=CroD4GW19awFqa9hXkCeAg==; cmctid=18; xxzlclientid=8f58ce17-0576-4940-a7fb-1706423853900; xxzlxxid=pfmx7MUmM8VixI13t01IeuJpaE7nlFptUB/mPoV1q++WvE+/s4Sh5ZOJ9po0Q5tMZzcr; isp=true; 58tj_uuid=03c1025a-bdc6-452d-a2c3-cc3cfdd59d61; als=0; sessid=2EA02F0C-1717-C3C8-AA45-09D3E74233A4; twe=2; lps=https%3A%2F%2Ftj.zu.anjuke.com%2F%3Fkw%3D%7Chttps%3A%2F%2Ftianjin.anjuke.com%2F; _ga=GA1.2.828932174.1706469611; _gid=GA1.2.1459984640.1706469611; fzq_js_anjuke_ershoufang_pc=8dffc378528e8c9f107195de37ee2233_1706485451179_24; obtain_by=2; xxzlbbid=; init_refer=https%253A%252F%252Ftianjin.anjuke.com%252F; new_uv=4; _gat=1; new_session=0; _ga_DYBJHZFBX2=GS1.2.1706508382.2.0.1706508382.0.0.0; ctid=11; xxzl_cid=f286055eadc049b8bf8dd7729782d419; xxzl_deviceid=cg2S64JHJ5nTZK9fuklwMpIIpnWrTu1lTth5PwBu726ME039VVCVrULrWmUjVqOt',
        'host': 'tianjin.anjuke.com',
        'pragma': 'no-cache',
        'referer': 'https://tianjin.anjuke.com/sale/p1/',
...
if __name__ == '__main__':
    ...
    for i in range(crawler_pages, crawler_pages + page_size):
        region = "tianjin"
        url = 'https://tianjin.anjuke.com/sale/p{page}lc1/'
